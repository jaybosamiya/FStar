            ...
            let discriminate scrutinee_tm f =
                ...
                then
                    ...
                    match Env.try_lookup_lid env discriminator with
                        ...
                        | _ ->
                            let disc = S.fvar discriminator (Delta_defined_at_level 1) None in
                ...
                | Tm_app(head, args) ->
                    ...
                    then []
                            ...
                            match Env.try_lookup_lid env projector with
                             | None -> []
                             | _ ->
                                let sub_term = mk_Tm_app (S.fvar (Ident.set_lid_range projector f.p) (Delta_defined_at_level 1) None) [as_arg scrutinee_tm] None f.p in
