...
let mk_discriminator_and_indexed_projectors iquals                   (* Qualifiers of the envelopping bundle    *)
    ...
    let arg_binder =
        ...
        then unrefined_arg_binder //records have only one constructor; no point refining the domain
             ...
             let sort =
                 let disc_fvar = S.fvar (Ident.set_lid_range disc_name p) (Delta_defined_at_level 1) None in
        ...
        then [] // We do not generate discriminators for record types
            ...
            then [decl]
                ...
                let dd =
                    ...
                    then Delta_abstract (Delta_defined_at_level 1)
                    else (Delta_defined_at_level 1)
                in
    ...
    let subst = fields |> List.mapi (fun i (a, _) ->
            ...
            let field_proj_tm = mk_Tm_uinst (S.fv_to_tm (S.lid_as_fv field_name (Delta_defined_at_level 1) None)) inst_univs in
